	...
	render() {
		...
		var getArcs = function () {
			...
			gaugeRanges.forEach(function (range, i) {
				arcs.push(drawArc(gaugeStart + range.start * gaugeLength, gaugeStart + range.end * gaugeLength, range.color, i));
			});
			return arcs;
		};
		...
		var getArrow = function () {
			...
			var describe = ["M", point1.x, point1.y, "L", point2.x, point2.y, "L", point3.x, point3.y, "Z"].join(" ");
		...
		}, getArcs(), getTicks(), getLabels(), getCenterLine(), getArrow());
	}
}
